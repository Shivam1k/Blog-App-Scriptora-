      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        <div className="mt-12 border-t pt-8 text-center">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Scriptora. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
...
// BlogFooter Component Flowchart

// BlogFooter Component
// │
// └── <footer> (Wrapper)
//     │
//     └── Container: max width, padding (Responsive spacing)
//         │
//         ├── Grid Layout (Responsive Columns)
//         │   ├── Branding Section (md: 2 cols)
//         │   │   ├── Logo Title: "ByteCode" (Gradient + Text)
...
//         │   │   └── Licenses
//         │   │
//         │   └── Newsletter (md: 2 cols)
//         │       ├── Title: "Stay Updated"
//         │       ├── Input (Email) with Mail icon
//         │       └── Subscribe Button
//         │
//         └── Copyright
//             └── Year + "ByteCode. All rights reserved."
